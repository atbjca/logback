...
> **适用版本：** `1.2.13-nes.patch.2-SNAPSHOT`
...
| **version** | `1.2.13` | `1.2.13-nes.patch.2-SNAPSHOT` | 保留原始版本号 + 内部补丁标识 |

### 4.2 版本号规范

- 格式：`{原始版本}-nes.patch.{补丁序号}[-SNAPSHOT]`
- 示例：`1.2.13-nes.patch.2-SNAPSHOT`（开发阶段）、`1.2.13-nes.patch.1`（正式发布，2026-06-25）
