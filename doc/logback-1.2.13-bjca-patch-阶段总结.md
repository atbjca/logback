...
> **基线版本：** logback 1.2.13
> **补丁版本：** `1.2.13-nes.patch.1-SNAPSHOT`
...
| 5 | 版本管理 | `2a5f27fb3` | 版本号更新为 `1.2.13-nes.patch.1-SNAPSHOT` |
...
| 组件 | 保留原因 |
|---|---|
| Janino 依赖 (optional) | `<if>` 条件功能仍需要（已通过 CVE-2025-11226 修复加固） |
...
1. **发布正式版本：** 将 `1.2.13-nes.patch.1-SNAPSHOT` 去掉 SNAPSHOT 后缀，发布到内部 Maven 仓库
